  ...
  return (
    <StrictMode>
      <div className="land">
        <div className="sm:flex justify-center items-center p-10 gap-10 w-3/4 max-sm:w-full max-sm:p-2 max-sm:gap-4 bg-black/50">
          ...
          <div className="text-lg max-sm:text-sm">
            Landowners and environmental service providers play a pivotal role
            in positive environmental impact investments. By collaborating on
            sustainable land management and conservation projects, they help
            protect ecosystems, sequester carbon, and enhance biodiversity.
            These investments not only yield ecological benefits but also
            generate long-term value, aligning financial interests with
            environmental stewardship for a more sustainable future.
          </div>
        </div>
        {/* <div className="nwAa">
      ...
      <div className="nwB">
        ...
        <div className="nwBb">
          At Impact Ecosystem, collaboration with landowners and environmental
          service providers is pivotal. Our strategic alliances integrate
          non-profit grants, regenerative product discounts, and incentives for
          ecosystem services, fostering mutual relationships that support land
          conservation and sustainable practices. Environmental service
          providers contribute expertise and resources, aligning with our goals
          to forge impactful investments for financial returns and positive
          environmental change. Together, we strive to create a sustainable and
          prosperous future through collective efforts.
        </div>
      </div>
              ...
              >
                ...
                <div className="border-2 border-green-500/50 rounded-full">
                  <img
                    src={partner.logo}
                    alt="logo"
                    className="w-40 h-40 rounded-full object-scale-down"
                  />
                </div>
...
export default LandownersNetworks;
