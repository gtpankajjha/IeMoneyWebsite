...
const NGONetworks = () => {
  ...
  async function getPartnersByCategory() {
  ...
  console.log("filteredPartners", filteredData);
  ...
  return (
    <StrictMode>
      <div className="ngo">
        <div className="sm:flex justify-center items-center p-10 gap-10 w-3/4 max-sm:w-full max-sm:p-2 max-sm:gap-4 bg-black/50">
          ...
          <div className="text-lg max-sm:text-sm">
            NGOs and non-profit organizations play a crucial role in improving
            the environment through impact investments. They leverage funds for
            sustainable projects, such as reforestation, clean energy, and
            conservation efforts. By focusing on long-term ecological benefits
            rather than profit, they drive positive change, promote
            environmental stewardship, and inspire responsible corporate
            practices, contributing significantly to a greener future.
          </div>
        </div>
        {/* <div className="nwAa">
      ...
      <div className="nwB">
        ...
        <div className="nwBb">
          We support NGOs/Non-profits by funding, sharing expertise, and
          fostering partnerships to promote regenerative economies. Financial
          aid facilitates project implementation, while capacity building and
          networking enable knowledge exchange. Collaborative funding models and
          co-investment enhance impact. Impact assessment tools help measure
          outcomes, guiding effective initiatives. Advocacy for supportive
          policies and due diligence on projects ensure alignment with
          regenerative goals. Jointly, these efforts strengthen initiatives
          focusing on natural capital and community currency, accelerating
          sustainable development and fostering resilient, equitable economies.
        </div>
      </div>
      ...
      <div className="nwD">
        ...
        <div className="overflow-x-auto w-full">
          ...
          {/* {partnersData.map((partner, index) => (
            <div key={index}>
              <div
                className="grid grid-cols-5 gap-4 p-4 font-bold sm:text-lg bg-gray-50 hover:bg-gray-200 cursor-pointer"
                onClick={() => openModal(partner)}
              >
                <div className="p-4">{index + 1}.</div>
                <div className="p-4">{partner.name}</div>
                <div className="p-4">{partner.category}</div>
                <div className="text-blue-500 p-4">View</div>
                <div className="text-blue-500 p-4">Website</div>
              </div>
            </div>
          ))} */}
