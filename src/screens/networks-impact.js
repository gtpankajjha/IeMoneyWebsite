    ...
    <StrictMode>
      <div className="impact">
        <div className="sm:flex justify-center items-center p-10 gap-10 w-3/4 max-sm:w-full max-sm:p-2 max-sm:gap-4 bg-black/50">
          <div className="font-bold text-6xl text-center">IMPACT INVESTORS</div>
          <div className="text-lg max-sm:text-sm">
            Impact investing has become increasingly popular in recent years, as
            more investors are looking to align their investments with their
            values and make a positive impact in the world. Impact investors are
            a powerful force for good, helping to finance businesses and
            projects that have the potential to create positive change in
      ...
      <div className="nwB">
        ...
        <div className="nwBb">
          At Impact Ecosystem, our mission is a holistic revolution in impact
          investing, blending non-profit grants, regenerative product discounts,
          and ecosystem incentives with impactful investments. We seek
          collaborative partnerships with passionate impact investors to amplify
          our collective efforts, fostering a powerful ecosystem where
          investments catalyze social, environmental, and economic
          transformation. Together, we aim to build a purposeful world, creating
          meaningful ripples of change that nurture our planet for generations.
        </div>
      </div>
...
export default ImpactInvestorsNetworks;
